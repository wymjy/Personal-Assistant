                        ...
                        .setSingleChoiceItems(CalendarDataOperation.alarmName, 0,
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        if(alarmMusic!=null)
                                            alarmMusic.stop();
                                        alarmMusic = MediaPlayer.create(CalendarEditActivity.this, CalendarDataOperation.alarmResouces[which]);
...
//				Toast.makeText(CalendarAddActivity.this, "未选中", Toast.LENGTH_LONG).show();
    ...
    public void initSpinnerPromition() {
        ...
        spinnerAdvanceTime.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            public void onItemSelected(AdapterView<?> arg0, View arg1,
                                       int arg2, long arg3) {
                //获取所选择的重复次数
                advanceTime = arg2 + 1 + "";
